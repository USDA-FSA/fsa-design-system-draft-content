...
layout: post
title:  "Tables"
date:   2016-06-20 10:35:00 -0500
intro: "When tables are used to show data, the header cells that relate to the data cells need to be programatically linked. This makes table navigation for screen readers less painful."
